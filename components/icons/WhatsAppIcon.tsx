// Brand mark — no icon library ships an accurate WhatsApp glyph, so this one stays hand-drawn
// (the taste-skill "no hand-rolled icons" rule is about generic UI glyphs, not brand marks).
